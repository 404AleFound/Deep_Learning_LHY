...
timestamp = '20250829_171055'
steps_train, loss_train, acc_train = get_data_train_logger(f'./loggers/{timestamp}/train.log')
steps_val, loss_val, acc_val = get_data_val_logger(f'./loggers/{timestamp}/val.log', n_steps=77)
